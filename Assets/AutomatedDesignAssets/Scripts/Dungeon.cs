...
public class Dungeon {
		...
		public List<GameObject> tilesInDungeon = new List<GameObject>();

		private static int debugCounter = 0;

		public Dungeon(Rect mrect)
		{
			rect = mrect;
		...
		public bool Split(int minRoomSize, int maxRoomSize)
		{
			...
			if (splitH)
			{
				...
				int split = Random.Range(minRoomSize, maxRoomSize);
		...
		public void CreateCorridorBetween(Dungeon left, Dungeon right)
        {
            Rect lroom = left.GetRoom();
            Rect rroom = right.GetRoom();
